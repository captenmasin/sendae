...
return [
     ...
     */
    'version' => env('NATIVEPHP_APP_VERSION', '0.1.6'),
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.sendae.desktop'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'A calmer home for your social publishing'),
